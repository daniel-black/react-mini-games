...
function useHighScore(storageKey) {
  const [highScore, setHighScore] = (0, import_react2.useState)(0);
...
function MiniGame(props) {
  ...
  const [isOver, setIsOver] = (0, import_react3.useState)(false);
  const { highScore, updateHighScore } = useHighScore(highScoreKey);
  const lifecycle = (0, import_react3.useMemo)(() => {
    const base = {
      width,
      height,
      devicePixelRatio,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: __spreadValues({ display: "inline-block" }, style), className, children: [
    title ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontFamily: "system-ui, sans-serif", marginBottom: 8 }, children: title }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", { ref: canvasRef }),
          showHud ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              style: {
                position: "absolute",
          ...
          showControlsHint ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              style: {
                position: "absolute",
          ...
          isOver ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              style: {
                position: "absolute",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontWeight: 600 }, children: "Game Over" }),
...
function Runner(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MiniGame, __spreadValues({ game: "runner", title }, rest));
}
...
function Paddle(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MiniGame, __spreadValues({ game: "paddle", title }, rest));
}
